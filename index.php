...
<html lang="en">
  ...
  <body> 
     <header>
      <h1 class="text-center text-info badge-center badge-light">PROYECTO ALEXIS</h1>
         <h2 class="text-center text-light">Bases de datos <span class="badge badge-warning">Ausentismo</span></h2> 
     </header>    
